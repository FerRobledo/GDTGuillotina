...
class modelEquipo{
    ...
    public function getAllTeamByUserId($id){
        $sql = "SELECT e.*, u.hizoCambio, j.nombre AS nombre_jugador, j.apellido AS apellido_jugador, ej.es_capitan, ej.jugador_id, j.posicion, j.estado, j.puntos
        FROM usuario u 
    ...
    public function getAllInfoPtsTotal(){
        $sql = "SELECT u.nombre, u.apellido, e.nombre AS nombre_equipo, e.puntos, e.puntos_total 
        FROM usuario u 
