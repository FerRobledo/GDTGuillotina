...
class modelJugadores{
    ...
    public function newJugador($nombre, $apellido, $numero, $posicion){
        $sql = "INSERT INTO jugador (nombre, apellido, numero, posicion, puntos) VALUES (?,?,?,?,?)";
        $query = $this->db->prepare($sql);
        $query->execute([$nombre, $apellido, $numero, $posicion, 0]);
